...
-- Um forno elabora 1 corrida por vez — trava a criação de uma corrida nova
-- enquanto já existe outra em andamento (qualquer status antes de
-- TRANSFERIDA/CANCELADA) no mesmo forno. Fornos diferentes continuam
