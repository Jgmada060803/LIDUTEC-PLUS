...
alter table public.materiais_fusao drop constraint if exists materiais_fusao_tipo_check;
alter table public.materiais_fusao add constraint materiais_fusao_tipo_check
  check (tipo in ('SUCATA','RETORNO','CANAL','GUSA','ALTERNATIVO','LIGA_CORRECAO','OUTRO'));
